...
# provides non null output in Zen Epyc, null output in Ryzen
# in any case, no fine-grained vectorisation information
#advisor --collect=roofline --project-dir=./adv_o2_march_roof ./argonmd_o2_march.x &>out_adv_o2_march_roof
