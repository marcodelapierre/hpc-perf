...
# not available
#vtune -collect uarch-exploration -run-pass-thru=-timestamp=sys -r ./vtune_o2_march_uarch -- ./argonmd_o2_march.x

#advisor --collect=roofline --project-dir=./adv_o2_march ./argonmd_o2_march.x 16
